...
import com.ryan.hello.dto.AccessTokenDTO;
import com.ryan.hello.dto.GithubUser;
import com.ryan.hello.mapper.UserMapper;
import com.ryan.hello.model.User;
import com.ryan.hello.provider.GithubProvider;
...
public class AuthorizeController {
    ...
    private UserMapper userMapper;
      ...
      public String callback(@RequestParam(name="code") String code,
          ...
          accessTokenDTO.setClient_secret("github.redirect.uri");
